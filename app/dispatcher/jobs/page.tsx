...
export default function DispatcherJobsPage() {
  ...
  return (
    <div className="w-full py-4 md:py-6 space-y-6">
      <AdminPageHeader
        title="Jobs"
        description="Create, assign, reschedule, and monitor service jobs with dispatcher-focused status, priority, technician, and customer context."
        actions={
      ...
      <JobRegister
        ...
        jobsBasePath="/dispatcher/jobs"
        exportFileName="dispatcher-jobs.csv"
      />
